...
//        textItem.setText(receitas.get(0).toString());
//        textItem.setTag(Integer.toString(0));

       // textItem.setOnLongClickListener(new RetrieveOnClick());;
        ...
        mListView.setOnLongClickListener(new RetrieveOnClick());
